...
struct FortKitContractChecks {
    static func main() async throws {
        ...
        try cloudV2WireModelsKeepStableAgentAndGroupIdentity()
        try await cloudV2ClientUsesBearerGatewayAndClosedCommands()
        try cloudV2HandoffWireModelsEnforceDurableLinkage()
        try await cloudV2HandoffClientUsesClosedHumanCommands()
        try cloudV2RoutineWireModelsEnforceExactOwnerAndPins()
        try await cloudV2RoutineClientUsesClosedAgentOwnedCommands()
